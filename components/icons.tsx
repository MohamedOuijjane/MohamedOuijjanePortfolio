...
export function BehanceIcon({ className, ...props }: IconProps) {
  return (
    <svg
      ...
      {...props}
    >
      <path d="M7.5 11C8.9 11 10 10.1 10 8.5S8.9 6 7.5 6H3v5h4.5zM3 18h5c1.7 0 3-1.3 3-3s-1.3-3-3-3H3v6z" />
      <path d="M7.5 4C10 4 12 5.8 12 8.5c0 1.2-.5 2.3-1.3 3 1.3.8 2.3 2.2 2.3 3.5 0 2.8-2.2 5-5 5H1V4h6.5zM15 7h6v1.5h-6V7zM18 18c1.7 0 3-1.1 3-2.5h2c0 2.5-2.2 4.5-5 4.5-3.3 0-6-2.7-6-6s2.7-6 6-6c2.8 0 5 2 5 4.5h-2c0-1.4-1.3-2.5-3-2.5-2.2 0-4 1.8-4 4s1.8 4 4 4z" />
    </svg>
  );
}
...
export function DribbbleIcon({ className, ...props }: IconProps) {
  return (
    ...
    >
      ...
      <path d="M8.56 2.75c4.37 6.03 6.02 9.42 8.03 17.72M19.13 5.09C15.22 9.14 10.57 10.44 2 10.67M21.75 12.84c-6.62-1.41-12.14 1-16.38 6.32" />
    </svg>
  );
}
