        ...
        {socialLinks.map((link) => {
          ...
          return (
            <a
              ...
              className="group flex h-11 w-11 items-center justify-center rounded-full text-slate-500 transition-all duration-300 hover:-translate-y-1 hover:text-[#0B0F14] hover:bg-gray-100 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#0B0F14]"
            >
